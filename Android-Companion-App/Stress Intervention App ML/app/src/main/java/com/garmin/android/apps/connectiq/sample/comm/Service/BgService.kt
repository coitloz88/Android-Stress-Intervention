...
import com.garmin.android.apps.connectiq.sample.comm.ML.Classifier
...
/*        val notificationManager = getSystemService(NOTIFICATION_SERVICE) as NotificationManager
    ...
    private fun isLowerHRV(userHRV: Double): Boolean {
        ...
        return false
        */
        val inputData = mutableListOf(userHRV, 36.0, 127.0)

        val result = classifier.classify(inputData)
    ...
    private fun initClassifier() {
        ...
        try {
            ...
            Log.d(TAG, "classifier IOException")
        }
    }
}